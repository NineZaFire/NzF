...
class BossEnemy extends Enemy {
    ...
    protected static int healthBuff = 0;
    ...
    public void setRef(Player player, gameRun gamePanel, CopyOnWriteArrayList<bossLaser> bossLasers) {
        this.player = player;
        this.gamePanel = gamePanel;
    ...
    @Override
    protected void move() {
        if (rand.nextInt(30) == 0) dy = rand.nextInt(3) - 1;
        y += dy * speed;
        if (y < 0 || y > gamePanel.getHeight() - height) dy = -dy;
    }
